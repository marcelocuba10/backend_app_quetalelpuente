...
<div class="passwordBox animated fadeInDown">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="gYHxjZ">
                <a href="{{ url('/') }}/">
                    <img src="{{ asset('/public/adminLTE/images/logo/logo.png') }}" class="huRTra" color="auto" width="auto">
                </a>
            </div>

            <div class="ibox-content recovery-ibox">
                <div class="grfsd">
                    <a href="{{ url('/user/login') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> <span class="dfdfdf">Back</span></a>
                </div> 
                    ...
                    <div class="col-lg-12">
                        <div class="ibox collapsed" style="margin-bottom: 0px">
                            <div class="ibox-title">
                                ...
                                <a style="color: #000;" href="{{ url('/user/forget-password') }}"><h5>Send Recovery Password by Email</h5></a>
                                <p class="llpl">
